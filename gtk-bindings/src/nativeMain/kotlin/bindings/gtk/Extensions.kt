...
fun CPointer<GtkColumnView>.asColumnView(): ColumnView = ColumnView(this)
fun CPointer<GtkColumnViewColumn>.asColumnViewColumn(): ColumnViewColumn = ColumnViewColumn(this)
fun CPointer<GtkButton>.asButton(): Button = Button(this)
fun CPointer<GtkDialog>.asDialog(): Dialog = Dialog(this)
fun CPointer<GtkDropDown>.asDropDown(): DropDown = DropDown(this)
fun CPointer<GtkEditable>.asEditable(): Editable = EditableWrapper(this)
fun CPointer<GtkEntryBuffer>.asEntryBuffer(): EntryBuffer = EntryBuffer(this)
fun CPointer<GtkEntry>.asEntry(): Entry = Entry(this)
